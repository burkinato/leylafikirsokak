            ...
            <div class="user-box dropdown px-3">
                <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="user-info">
                        ...
                        <p class="designattion mb-0">Admin <i class="bx bx-chevron-down fs-7"></i></p>
                        
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><button id="logoutButton" class="btn btn-danger">Çıkış Yap</button></li>

                    
                    
                  
                        {{-- <li>
                            <a class="dropdown-item d-flex align-items-center" href="javascript:;" id="logout-btn">
